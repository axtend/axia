...
/home/user/parity-relay init-bridge millau-to-rialto \
...
/home/user/parity-relay init-bridge rialto-to-millau \
...
/home/user/parity-relay relay-headers-and-messages millau-rialto \
