...
///
/// This weight is larger (x2) than actual weight at current Betanet runtime to avoid unsuccessful
...
impl CliEncodeCall for Betanet {
	...
	fn encode_call(call: &Call) -> anyhow::Result<Self::Call> {
		Ok(match call {
			Call::Remark { remark_payload, .. } => relay_betanet_client::runtime::Call::System(
				relay_betanet_client::runtime::SystemCall::remark(
				...
				match *bridge_instance_index {
					bridge::BETANET_TO_WOCOCO_INDEX => {
						...
						relay_betanet_client::runtime::Call::BridgeMessagesWococo(
							relay_betanet_client::runtime::BridgeMessagesWococoCall::send_message(
	...
	fn get_dispatch_info(
		call: &relay_betanet_client::runtime::Call,
	) -> anyhow::Result<DispatchInfo> {
		match *call {
			relay_betanet_client::runtime::Call::System(
				relay_betanet_client::runtime::SystemCall::remark(_),
			) => Ok(DispatchInfo {
...
impl CliChain for Betanet {
	...
	fn encode_message(
		...
		Err(anyhow!("Sending messages from Betanet is not yet supported."))
	}
}
