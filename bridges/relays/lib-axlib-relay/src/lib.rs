...
//! The library of axlib relay. contains some public codes to provide to axlib relay.
...
///
/// There are no any strict requirements on block time in Axlib. But we assume here that all
/// Axlib-based chains will be designed to produce relatively fast (compared to the slowest
