...
impl SubstrateMessageLane for KusamaMessagesToAxia {
	...
	const INBOUND_LANE_LATEST_RECEIVED_NONCE_METHOD: &'static str =
		bp_axctest::FROM_KUSAMA_LATEST_RECEIVED_NONCE_METHOD;
	const INBOUND_LANE_LATEST_CONFIRMED_NONCE_METHOD: &'static str =
		bp_axctest::FROM_KUSAMA_LATEST_CONFIRMED_NONCE_METHOD;
	const INBOUND_LANE_UNREWARDED_RELAYERS_STATE: &'static str =
		bp_axctest::FROM_KUSAMA_UNREWARDED_RELAYERS_STATE;
					...
					UnsignedTransaction::new(
						relay_axctest_client::runtime::Call::BridgeAxiaMessages(
							relay_axctest_client::runtime::BridgeAxiaMessagesCall::update_pallet_parameter(
								relay_axctest_client::runtime::BridgeAxiaMessagesParameter::AxiaToKusamaConversionRate(
