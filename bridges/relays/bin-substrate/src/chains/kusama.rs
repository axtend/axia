				...
				match *bridge_instance_index {
					bridge::KUSAMA_TO_AXIA_INDEX => {
						...
						relay_kusama_client::runtime::Call::BridgeAxiaMessages(
							relay_kusama_client::runtime::BridgeAxiaMessagesCall::send_message(
...
pub(crate) fn axia_to_kusama_conversion_rate_params() -> (StorageKey, FixedU128) {
	(
		bp_runtime::storage_parameter_key(
			bp_kusama::AXIA_TO_KUSAMA_CONVERSION_RATE_PARAMETER_NAME,
		),
