...
pub struct Metrics {
	...
	/// Counts how many allychain candidates processed in `enter_inner`.
...
pub const METRICS: Metrics = Metrics {
	inherent_data_weight: CounterVec::new(ALLYCHAIN_INHERENT_DATA_WEIGHT),
	bitfields_processed: Counter::new(ALLYCHAIN_INHERENT_DATA_BITFIELDS_PROCESSED),
	candidates_processed: CounterVec::new(ALLYCHAIN_INHERENT_DATA_CANDIDATES_PROCESSED),
	dispute_sets_processed: CounterVec::new(ALLYCHAIN_INHERENT_DATA_DISPUTE_SETS_PROCESSED),
	disputes_included: Counter::new(ALLYCHAIN_INHERENT_DATA_DISPUTE_SETS_INCLUDED),
