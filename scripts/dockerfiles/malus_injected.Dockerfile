...
LABEL io.parity.image.authors="devops-team@parity.io" \
	...
	io.parity.image.description="Malus - the nemesis of axia" \
	io.parity.image.source="https://github.com/paritytech/axia/blob/${VCS_REF}/scripts/dockerfiles/malus.Dockerfile" \
