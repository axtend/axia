...
- A pull request that does not alter any logic (e.g. comments, dependencies, docs) may be tagged [`insubstantial`](https://github.com/axiatech/axia/pulls?utf8=%E2%9C%93&q=is%3Apr+is%3Aopen+label%3AA2-insubstantial) and merged by its author.
...
- All other PRs should sit for 48 hours with the [`pleasereview`](https://github.com/axiatech/axia/pulls?q=is:pr+is:open+label:A0-pleasereview) tag in order to garner feedback.
